...
import com.example.todoapp.navigation.BoottomNavigationItem
import com.example.todoapp.navigation.Screens
import com.example.todoapp.navigation.popUpToTop
...
fun BottomBar(navController: NavHostController) {
    ...
    Box(
        ...
        Row(
            ...
            BoottomNavigationItem().bottomNavigationItems()
                .forEachIndexed { index, bottomNavigationItem ->
                    if (bottomNavigationItem.rout == Screens.MainApp.AddScreen.rout) {
                        Icon(
                            ...
                            modifier = Modifier
                                ...
                                .clickable {
                                    ...
                                    navController.navigate(bottomNavigationItem.rout) {
